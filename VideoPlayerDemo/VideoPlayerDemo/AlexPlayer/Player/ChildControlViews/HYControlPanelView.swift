...
class AlexControlPanelView: UIView {
    
    /// 播放｜暂停
    var playButton: AlexResponseExpandButtton = {
        let btn = AlexResponseExpandButtton()
        btn.setImage(UIImage(named: "alex_video_ic_play", in: Alex_SOURCE_BUNDLE, compatibleWith: nil), for: .normal)
        return btn
    }()
    
    /// 全屏
    var screenButton: AlexResponseExpandButtton = {
        let btn = AlexResponseExpandButtton()
        btn.setImage(UIImage(named: "alex_video_ic_normalscreen", in: Alex_SOURCE_BUNDLE, compatibleWith: nil), for: .normal)
        return btn
    }()
    ...
    var slider: UISlider = {
        ...
        slider.setThumbImage(UIImage(named: "alex_video_ic_slider", in: Alex_SOURCE_BUNDLE, compatibleWith: nil), for: .normal)
        return slider
    }()
