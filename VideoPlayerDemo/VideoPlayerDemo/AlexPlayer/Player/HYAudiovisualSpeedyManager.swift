...
class AlexAudiovisualSpeedyManager {
    ...
    enum SpeedyType {
        ...
        var remindImg: UIImage? {
            switch self {
            case .fastForward:
                return UIImage(named: "alex_video_fastForward", in: Alex_SOURCE_BUNDLE, compatibleWith: nil)
            case .fastRewind:
                return UIImage(named: "alex_video_fastRewind", in: Alex_SOURCE_BUNDLE, compatibleWith: nil)
            case .lightingUp, .lightingDown:
                return UIImage(named: "alex_video_light", in: Alex_SOURCE_BUNDLE, compatibleWith: nil)
            default:
                return nil
            }
        }
...
//        v.showsRouteButton = true
    ...
    func movedDrag(point: CGPoint) {
        ...
        else if startPoint.x < Alex_SCREEN_WIDTH / 2
